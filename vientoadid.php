...
$consulta = "SELECT * FROM vientoandino WHERE id=$id";
...
$imagen=$datos["imagen"];
?>
  <button type="submit"><a href="despensava.php">Despensa</a></button>
    <button type="submit"><a href="congeladosva.php">congelados</a></button>
<div class="container">
  <div class="row">
    <div class="card w-50">
